<footer id="menu-voet">
    ...
    <section class="menu-boxen grid-vlak2">
        <h1 class="menu-kop">Openingstijden</h1>
        <article class="menu-flex-2">
            <p class="menu-tekst">Doordeweeks</p>
            <p class="menu-tekst">17:00 - 21:00</p>
        </article>
        <article class="menu-flex-2">
            <p class="menu-tekst">Weekend</p>
            <p class="menu-tekst">15:00 - 23:00</p>
        </article>
    </section>
